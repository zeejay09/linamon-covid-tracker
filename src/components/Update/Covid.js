...
export default class Covid extends Component {
    ...
    componentDidMount = () => {
        ...
        axios.get('/view/covid-case/' + this.props.match.params.id, {headers:{Authorization: authToken}}).then(
            response => {
    ...
    render() {
        ...
        <Formik
            ...
            onSubmit={(values) => {
                ...
                console.log(values);
                axios.put('/edit/covid-case/' + this.state.userId, values, {headers:{Authorization: authToken}}).then(
                    res => {
                        if (res.status === 200) {
